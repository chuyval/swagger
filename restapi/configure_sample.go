...
import (
	...
	"swagger/restapi/operations/pet"
	"swagger/restapi/operations/store"
	"swagger/restapi/operations/user"
)

// This file is safe to edit. Once it exists it will not be overwritten

//go:generate swagger generate server --target .. --name sample --spec ../swagger_sample.yaml
